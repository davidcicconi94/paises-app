...
export class Convert {
  public static toSearchByName(json: string): Pais[] {
    return cast(JSON.parse(json), a(r('SearchByName')));
  }

  public static searchByNameToJson(value: Pais[]): string {
    return JSON.stringify(uncast(value, a(r('SearchByName'))), null, 2);
  }
}
